...
export async function notifyProfessionalStatus(req, res, next) {
  try {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${origin}" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); color: white; padding: 15px 40px; border-radius: 8px; text-decoration: none; font-size: 16px; font-weight: bold; display: inline-block;">
              🚀 Acessar Sistema
            </a>
          </div>
        </div>
